...
./configure --build=aarch64-apple-darwin --prefix=/usr/local --enable-shared --enable-static=no --without-python&&
make&&
...
./configure --build=arm-apple-darwin --prefix=/usr/local --enable-shared --enable-static=no --without-python&&
make&&
