...
make -j3 LDFLAGS='-isysroot /usr/share/SDKs/iPhoneOS7.1.sdk -miphoneos-version-min=7.0 -arch armv7 -L/usr/local/lib'&&
make -j3 install DESTDIR=${CURRENTDIR}/build/armv7 LDFLAGS='-isysroot /usr/share/SDKs/iPhoneOS7.1.sdk -miphoneos-version-min=7.0 -arch armv7 -L/usr/lib -L/usr/local/lib'
