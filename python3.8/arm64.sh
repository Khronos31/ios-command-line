...
export LDFLAGS='-isysroot /usr/share/SDKs/iPhoneOS.sdk -miphoneos-version-min=7.0 -arch arm64 -L/usr/local/lib'
...
make -j3&&
make -j3 install DESTDIR=${CURRENTDIR}/build/arm64
